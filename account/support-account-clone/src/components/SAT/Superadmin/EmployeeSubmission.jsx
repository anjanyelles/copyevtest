    ...
    return (
        <div style={{ display: "flex", flexDirection: "column", padding: "20px" }}>
            <div style={{ maxWidth: "800px" }}>
                ...
                <img 
                    src="   https://res.cloudinary.com/danfpnuui/image/upload/v1737632108/submission_-1_xewpab.png"  
                ...
                <h4 style={{ fontSize: "18px", fontWeight: "300", color: "#000000", marginTop: "10px", marginBottom: "10px" }}>
                    Edit Submission Sheets
                </h4>
                <img 
                    src="  https://res.cloudinary.com/danfpnuui/image/upload/v1737632125/edit_submission_acnnie.png"  
