...
const ConsultantAiResumeMatcher = () => {
    return (
        <div className="ai-resume-matcher-container">
            <div className="content-section">
                ...
                <img
                    src="https://res.cloudinary.com/danfpnuui/image/upload/v1737613512/MATCHER-1_xfk628.png"
...
export default ConsultantAiResumeMatcher;
