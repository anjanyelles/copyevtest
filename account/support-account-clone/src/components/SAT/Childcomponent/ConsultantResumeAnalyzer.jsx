...
const ConsultantResumeAnalyzer = () => {
    return (
        <div className="ai-resume-matcher-container">
            <div className="content-section">
                ...
                <img
                    src="https://res.cloudinary.com/danfpnuui/image/upload/v1737550292/Resume_analzer-1_yqbbzb.png"
...
export default ConsultantResumeAnalyzer;
