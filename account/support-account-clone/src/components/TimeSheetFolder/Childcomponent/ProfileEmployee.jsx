...
const ProfileEmployee = () => {
    return (
        <div>
            ...
            <img 
                src="https://res.cloudinary.com/danfpnuui/image/upload/v1737208928/Pro-6_cvobcd.png"  // Replace with your image URL
            ...
            <img 
                src="https://res.cloudinary.com/danfpnuui/image/upload/v1737209012/Pro-1_iww6qf.png"  // Replace with your image URL
                alt="SAT Report Generation"
                style={{ width: "60%", height: "auto", marginBottom: "20px" }} 
            />
            ...
            <img 
                src="https://res.cloudinary.com/danfpnuui/image/upload/v1737209224/Pro-5_vwzsm8.png"  // Replace with your image URL
                alt="SAT Report Generation"
                style={{ width: "60%", height: "auto", marginBottom: "20px" }} 
            />
            <h3 style={{ fontSize: "20px", fontWeight: "300", color: "#000000", marginTop: "20px", marginBottom: "10px" }}>
            ...
            <img 
                src="https://res.cloudinary.com/danfpnuui/image/upload/v1737209091/Pro-2_qitvps.png"  // Replace with your image URL
                alt="SAT Report Generation"
                style={{ width: "60%", height: "auto", marginBottom: "20px" }} 
            />
            <h3 style={{ fontSize: "20px", fontWeight: "300", color: "#000000", marginTop: "20px", marginBottom: "10px" }}>
            ...
            <img 
                src="https://res.cloudinary.com/danfpnuui/image/upload/v1737209533/Pro-4_ghjzn2.png"  // Replace with your image URL
                alt="SAT Report Generation"
                style={{ width: "60%", height: "auto", marginBottom: "20px" }} 
            />
            <p style={{ fontSize: "16px", lineHeight: "1.6", color: "#4F4F4F" }}>
            ...
            <img 
                src="https://res.cloudinary.com/danfpnuui/image/upload/v1737209534/Pro-3_zd2o87.png"  // Replace with your image URL
                alt="SAT Report Generation"
                style={{ width: "60%", height: "auto", marginBottom: "20px" }} 
            />
            <h3 style={{ fontSize: "20px", fontWeight: "300", color: "#000000", marginTop: "20px", marginBottom: "10px" }}>
