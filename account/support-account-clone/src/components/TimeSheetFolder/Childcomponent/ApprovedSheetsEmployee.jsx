...
import './EmployeeApprovedSheets.css'; // Import the CSS file for styles

const ApprovedSheetsEmployee = () => {
    return (
        <div className="view-approved-sheets-container">
            <div className="content-section">v
                ...
                src=" https://res.cloudinary.com/danfpnuui/image/upload/v1737352875/Approved_sheets-1_e1w0sw.png"
...
export default ApprovedSheetsEmployee;
