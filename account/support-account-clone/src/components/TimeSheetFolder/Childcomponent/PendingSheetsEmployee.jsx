...
import './PendingSheetsEmployee.css'; // Import the CSS file for styles

const PendingSheetsEmployee = () => {
    return (
        <div className="pending-time-sheets-container">
            <div className="content-section">
                ...
                src="  https://res.cloudinary.com/danfpnuui/image/upload/v1737352972/Pending_sheets-1_zgdv7g.png"
...
export default PendingSheetsEmployee;
