...
import './EmployeeRecalledSheet.css'; // Import the CSS file for styles

const EmployeeRecalledSheet = () => {
    return (
        <div className="rejected-time-sheets-container">
            <div className="content-section">
                ...
                src="  https://res.cloudinary.com/danfpnuui/image/upload/v1737459323/WhatsApp_Image_2025-01-21_at_4.41.17_PM_um26fw.jpg"
...
export default EmployeeRecalledSheet;
