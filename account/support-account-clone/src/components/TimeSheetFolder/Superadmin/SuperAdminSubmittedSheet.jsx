...
const SuperAdminSubmittedSheet= () => {
    return (
        <div className="view-submitted-sheets-container">
            <div className="content-section">
                ...
                src="  https://res.cloudinary.com/danfpnuui/image/upload/v1737466428/Screenshot_2025-01-21_153124_qkuxud.png"
...
export default SuperAdminSubmittedSheet;
