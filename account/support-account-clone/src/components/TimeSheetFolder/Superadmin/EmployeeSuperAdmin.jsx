    ...
    return (
        <div>
            ...
            <img
                ...
                src=" https://res.cloudinary.com/danfpnuui/image/upload/v1737456668/Screenshot_2025-01-21_152625_ypiiap.png"
            ...
            <img
                className="placeholder-image image_gatnix_support"
                src="   https://res.cloudinary.com/danfpnuui/image/upload/v1737456826/Screenshot_2025-01-21_152739_m0iqbb.png"
                alt="Employee Table Screenshot"
            />
            <p className="description">
                To edit an Employee's details, click the "Edit" button in the corresponding row. This opens a form pre-filled with the existing details of the selected manager. After making the necessary changes, click <strong>Save</strong> to update the information.
            </p>
