    ...
    return (
        <div>
            ...
            <img
                ...
                src="https://res.cloudinary.com/danfpnuui/image/upload/v1737374961/Client-1_n0av9e.png"
            ...
            <img
                className="placeholder-image image_gatnix_support"
                src="  https://res.cloudinary.com/danfpnuui/image/upload/v1737375053/Client-2_vqzlkl.png"
                alt="Employee Table Screenshot"
            />
            <p className="description">
