! function(e) {
    ...
    r.m = e, r.c = n, r.d = function(e, n, t) {
        ...
        if (r.r(t), Object.defineProperty(t, "default", {
            ...
            for (var d in e) r.d(t, d, function(n) {
                return e[n]
            }.bind(null, d));
        return t
    }, r.n = function(e) {
    ...
    class r extends elementorModules.frontend.handlers.Base {
        ...
        onClick() {
            ...
            this.elements.$card_header.on("click", (function(n) {
                ...
                r.hasClass("expand") ? (r.find(".card-expand").slideUp(), r.removeClass("expand")) : (e.elements.$wrapper.find(".card-expand").slideUp(), e.elements.$wrapper.find(".card-wrapper").removeClass("expand"), r.addClass("expand"), r.find(".card-expand").slideDown())
            }))
        }
    }
